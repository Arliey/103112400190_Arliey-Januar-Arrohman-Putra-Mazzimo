...
```
Program ini merupakan implementasi Multilevel Linked List (MLL) menggunakan bahasa C++ yang digunakan untuk mengelola data kategori makanan sebagai node parent dan menu makanan sebagai node child. List induk menyimpan node parent dalam bentuk double linked list, sedangkan setiap node parent memiliki list anak yang menyimpan data menu makanan sesuai kategorinya. Program menyediakan fitur inisialisasi list, penambahan data parent dan child, penampilan seluruh struktur multilist, pencarian data child berdasarkan ID, serta penghapusan node child dan node parent beserta seluruh anaknya. Implementasi ini bertujuan untuk membantu memahami konsep hubungan bertingkat (parent–child) dan operasi dasar pada struktur data multilevel linked list.
...
## Referensi
[1] Mbejo, Maria Triani., Nopa, Ledi Alde., Putri, Jingga Saftina., Risky, M. (2025). “Analisis Struktur Data Linked List dalam Pengolahan Data Mahasiswa”. _Jurnal Sains Informatika Terapan (JSIT)_, 2(2), 441–444. Diakses pada 13 Desember 2025 melalui https://rcf-indonesia.org/jurnal/index.php/jsit/article/view/591/418
<br>**[2]** Wijoyo, Agung., Prasetiyo, Alif Ramdhani., Salsabila, Afra Anggita., Nife, Kristina., Murni., Nadapdap, Pandri Budiman. (2024). “Evaluasi Efisiensi Struktur Data Linked List pada Implementasi Sistem Antrian”. _Jurnal Riset Informatika dan Inovasi (JRIIN)_, 1(12), 1244–1246. Diakses pada 13 Desember 2025 melalui https://jurnalmahasiswa.com/index.php/jriin/article/view/1060/678